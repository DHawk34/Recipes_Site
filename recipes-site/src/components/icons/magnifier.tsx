...
export class Magnifier extends React.Component<MyProps, {}> {
    render(): React.ReactNode {
        return (
            <svg width={this.props.width} height={this.props.height} viewBox="0 0 1280.000000 1270.000000"><g transform="translate(0.000000,1270.000000) scale(0.100000,-0.100000)"
