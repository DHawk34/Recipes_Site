...
public class AuthService
{
    ...
    public string CreateAccessToken(Guid userPublicID)
    {
    ...
    public Task<UserRefreshToken?> GetUserRefreshTokenAsync(Guid userPublicID, Guid deviceID)
    {
        return refreshTokenRepo.GetAsync(userPublicID, deviceID);
    }

    public Task<RefreshToken?> CreateRefreshTokenAsync(int userID, Guid deviceID)
    {
    ...
    private static RefreshToken CreateRefreshToken()
    {
        return new RefreshToken
        {
            ...
            ExpiresDate = DateTime.Now.Add(refreshTokenLifetime)
        };
    }
